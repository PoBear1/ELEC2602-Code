...
module part2_TB;
	...
	always @(count) begin
		...
		4'b1000 : begin input1 = 1'b0; input2 = 1'b1; input3 = 1'b1; input4 = 1'b0; select = 2'b10; end
		4'b1001 : begin input1 = 1'b0; input2 = 1'b1; input3 = 1'b1; input4 = 1'b0; select = 2'b01; end
		4'b1010 : begin input1 = 1'b0; input2 = 1'b1; input3 = 1'b1; input4 = 1'b0; select = 2'b00; end
